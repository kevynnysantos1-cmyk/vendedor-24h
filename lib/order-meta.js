...
const PRECOS = {
  ...
  b1:   { id: 'b1',   name: 'Designer 24h (IA)',          price: 27.0 },
  b2:   { id: 'b2',   name: 'Recuperador de Vendas 24h',  price: 27.0 },
  b3:   { id: 'b3',   name: 'Máquina de Conteúdo 24h',    price: 19.0 },
  up1:  { id: 'up1',  name: 'Ativação Feita Pra Você (pós-compra)', price: 47.0 },
};
...
function buildMetadata(o) {
  ...
  const m = {
    ...
    fbclid: String(utms.fbclid || '').slice(0, 200),
    event_source_url: String(meta.event_source_url || '').slice(0, 300),
    ...
    products_json: JSON.stringify(o.products || productsFor(o.bumps)).slice(0, 900),
